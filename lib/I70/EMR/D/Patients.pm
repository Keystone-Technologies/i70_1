...
sub rest_list { shift->SUPER::rest_list('SELECT * FROM emrd_patients patients') }
...
% layout 'pqgrid', url => "/emr_d/patient";
% title 'Patients';
% content_for 'colM' => begin
  ...
  { title: "SSN", width: 160 },
  { title: "DoB", width: 190 },
  { title: "Ethnicity", width: 190 },
  { title: "Household Income", width: 190 }
% end
